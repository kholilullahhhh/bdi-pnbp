...
import { getStatusLabel, getStatusVariant, formatCurrency, formatDateTime } from "@/lib/utils";
...
export default async function AdminApplicationDetailPage({
  ...
  if (!userRole || !["OPERATOR", "ADMIN", "SUPER_ADMIN"].includes(userRole)) {
    notFound();
  }
  ...
  const validTransitions = getValidTransitions(application.status, userRole);
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {application.notes && (
            <div className="bg-white rounded-xl border border-border overflow-hidden">
              <div className="px-6 py-4 border-b border-border">
                <h3 className="text-base font-bold text-foreground">Catatan Pemohon</h3>
              </div>
              <div className="p-6">
                      ...
                      <div key={history.id} className="flex gap-4">
                        ...
                        <div className="pb-8 flex-1">
                          ...
                          <p className="text-xs text-muted-foreground mt-0.5">
                            ...
                            {history.changedBy && ` — ${history.changedBy.name} (${history.changedBy.role})`}
                          </p>
                          {history.notes && (
            ...
            <div className="bg-white rounded-xl border border-border overflow-hidden">
              ...
              <div className="p-6 space-y-3">
                <div className="flex justify-between">
                  <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Nomor</span>
